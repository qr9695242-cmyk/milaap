...
const TIER_BANDS = [
  { through: 5, name: "Bronze Patron", icon: "🥉", color: "#C08552", gradient: "linear-gradient(135deg,#6e4420 0%,#c98a4b 45%,#8a5a2b 75%,#5a3a1a 100%)", sheenSpeed: "4.2s" },
  { through: 10, name: "Silver Patron", icon: "🥈", color: "#C7CDD8", gradient: "linear-gradient(135deg,#6b7480 0%,#e6ebf0 45%,#a3abb5 75%,#565d66 100%)", sheenSpeed: "3.9s" },
  { through: 15, name: "Gold Patron", icon: "🥇", color: "#D4A64A", gradient: "linear-gradient(135deg,#6b4e12 0%,#f0c766 45%,#c9973f 75%,#573c0d 100%)", sheenSpeed: "3.6s" },
  { through: 20, name: "Platinum Patron", icon: "💎", color: "#1FA7B3", gradient: "linear-gradient(135deg,#0a4850 0%,#7fe0ea 45%,#2fb6c2 75%,#073a41 100%)", sheenSpeed: "3.3s" },
  { through: 25, name: "Diamond Patron", icon: "💠", color: "#0E7490", gradient: "linear-gradient(135deg,#043c47 0%,#5fd7e8 45%,#0e93a8 75%,#032b33 100%)", sheenSpeed: "3.0s" },
  { through: 30, name: "Elite Patron", icon: "🔱", color: "#7C3AED", gradient: "linear-gradient(135deg,#2e1065 0%,#c4a6fb 45%,#7c3aed 75%,#210a4a 100%)", sheenSpeed: "2.8s" },
  { through: 35, name: "Royal Patron", icon: "👑", color: "#C97A2B", gradient: "linear-gradient(135deg,#4f2f0c 0%,#f2b25c 45%,#c97a2b 75%,#3a2208 100%)", sheenSpeed: "2.6s" },
  { through: 40, name: "Legend Patron", icon: "🔥", color: "#B5451B", gradient: "linear-gradient(135deg,#4a1509 0%,#ff8a5c 45%,#b5451b 75%,#331004 100%)", sheenSpeed: "2.4s" },
  { through: 45, name: "Mythic Patron", icon: "🌟", color: "#FF3B7F", gradient: "linear-gradient(135deg,#5c0930 0%,#ff8fb8 45%,#ff3b7f 75%,#450624 100%)", sheenSpeed: "2.1s" },
  { through: 50, name: "Immortal Patron", icon: "🏆", color: "#F5C34D", gradient: "linear-gradient(135deg,#7a5c0e 0%,#fff0bd 30%,#ffe08a 50%,#f5c34d 75%,#8a6a10 100%)", sheenSpeed: "1.8s" },
];

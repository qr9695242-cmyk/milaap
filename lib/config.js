...
//     kitne Rs milte hain (recharge price ke hisaab se: 100 coins = Rs 150,
//     so 1 coin = Rs 1.5; diamond = 2 coins worth, isliye 1 diamond = Rs 3)
export const GIFT_DIAMOND_RATE = 0.5;
export const DIAMOND_WITHDRAW_RATE_RS = 3;

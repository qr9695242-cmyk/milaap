...
//     earns 70 diamonds (rate = 1/200 — every 200 coins spent = 1 diamond for the receiver). Isse related koi bhi label, tooltip
...
export const GIFT_DIAMOND_RATE = 1 / 200; // 200 gifted coins = 1 diamond
...
// needed — unlike recharge/withdraw). Rate is the inverse of GIFT_DIAMOND_RATE for the in-app exchange.
export const DIAMOND_TO_COIN_RATE = 200; // 1 diamond = 200 coins for in-app exchange

...
export const HOST_LEVELS = [
  { level: 1, name: "Rising Host", minDiamonds: 0, icon: "🌱", color: "#9AA3AC" },
  { level: 2, name: "Bronze Host", minDiamonds: 1000, icon: "🥉", color: "#C08552" },
  { level: 3, name: "Silver Host", minDiamonds: 5000, icon: "🥈", color: "#C7CDD8" },
  { level: 4, name: "Gold Host", minDiamonds: 20000, icon: "🥇", color: "#D4A64A" },
  { level: 5, name: "Platinum Host", minDiamonds: 50000, icon: "💎", color: "#1FA7B3" },
  { level: 6, name: "Diamond Host", minDiamonds: 150000, icon: "💠", color: "#0E7490" },
  { level: 7, name: "Elite Host", minDiamonds: 400000, icon: "👑", color: "#C97A2B" },
  { level: 8, name: "Legend Host", minDiamonds: 1000000, icon: "🔥", color: "#B5451B" },
];
